...
export class RecommendationService {
  private recommended_url = "http://13.126.220.1:9078/recommendation/api/v1/";
  private genrebasedmovies_url =
    "http://13.126.220.1:9078/api/v1/getGenreBasedMoviesForUser/";
  private languagebasedmovies_url =
    "http://13.126.220.1:9078/api/v1/getLanguageBasedMoviesForUser/";
  private languagegenrebased_url =
    "http://13.126.220.1:9078/api/v1/getGenreLanguageBasedMoviesForUser/";
