...
export class RsvpService {
  data: any;
  private _url = "http://10.20.1.16:9075/api/v1/event";
  movies_url = "http://10.20.1.16:9075/api/v1/event/get/?emailId=";
  email_url = "http://10.20.1.16:9076/api/v1/email/sendEmail";
