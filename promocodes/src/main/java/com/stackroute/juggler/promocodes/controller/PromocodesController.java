...
public class PromocodesController {
 ...
 @RequestMapping(value = "/promocode/{code}", method = RequestMethod.GET, produces = { "application/json" })
 ...
 @RequestMapping(value = "/promocode/{code}", method = RequestMethod.DELETE, produces = { "application/json" })
	public ResponseEntity<?> savePromocode(@PathVariable String code) {
		
	 String status=promoservice.delete(code);
