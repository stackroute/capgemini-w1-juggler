...
//	// delete by id
//	@Override
//	public Show deleteByScheduler(String theatreName, String date, String slot) {
//		return (Show)hashOperations.getBySc("SHOW", theatreName, date, slot);
//	}
...
//		
//		return hashOperations.multiGet("SHOW", hashKeys);
//	}
