...
public class KafkaConsumer {
	...
	public ConsumerFactory<String, MovieSchedule> consumerFactory() {
		...
		config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "10.20.1.216:9092");
	...
	public ConsumerFactory<String, TicketDetails> payConsumerFactory() {
		...
		payConfig.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "10.20.1.216:9092");
	...
	public ConsumerFactory<String, TriggerMessage> schedulerConsumerFactory() {
		...
		schedulerConfig.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "10.20.1.216:9092");
