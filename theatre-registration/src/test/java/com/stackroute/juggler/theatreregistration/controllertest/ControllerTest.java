...
public class ControllerTest {
	...
	public void setUp() throws Exception {
		...
		theatre = new Registration("802", "koramangala-5-67", "chennai", "ABC", "7", "100", map, sm, rm);
		theatres.add(theatre);
		theatre = new Registration("802", "koramangala-5-67", "chennai", "LMN", "7", "100", map, sm, rm);
		theatres.add(theatre);
	}
	...
	public void testUpdateTheatreByName() throws Exception {
		...
		theatreMockMvc.perform(put("/api/v1/theatre","xyz")).andExpect(status().isOk());
