...
//		this.id = id;
	...
	public String toString() {
		return "Movie [ movieId=" + movieId + ", name=" + name + ", moviePoster=" + moviePoster
				+ ", synopsis=" + synopsis + ", movieReleasedate=" + movieReleasedate + ", movieDuration="
				+ movieDuration + ", format=" + format + ", hero=" + hero + ", heroine=" + heroine + ", director="
				+ director + ", releasedInCity=" + releasedInCity + ", movieGenres=" + movieGenres + ", language="
				+ language + ", theatres=" + theatres + ", city=" + city + ", genre=" + genre + ", languages="
				+ languages + "]";
	}
